package com.smktelkom.rahmad.bookinventory;
...
import com.smktelkom.rahmad.bookinventory.activity.BasicActivity;
import com.smktelkom.rahmad.bookinventory.adapter.BooksAdapter;
import com.smktelkom.rahmad.bookinventory.adapter.DividerDecoration;
import com.smktelkom.rahmad.bookinventory.helper.HelperFunction;
...
public class MainActivity extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    private void prepareBookData() {
        Book book = new Book("9780439064873", "Harry Potter And The Chamber Of Secret", "J.K. Rowling", 2000, "Fantasy, Thriller, Mystery", "This is some synopsis", R.drawable.placeholder);
        bookList.add(book);

        book = new Book("9780316015844", "Twilight (The Twilight Saga, Book 1)", "Stephanie Meyer", 2006, "Fantasy, Drama,Romance", "This is some synopsis", R.drawable.placeholder);
        bookList.add(book);

        book = new Book("9781484724989", "Journey to Star Wars: The Force Awakens Lost Stars", "Claudia Gray", 2015, "Action, Thriller, Science Fiction", "This is some synopsis", R.drawable.placeholder);
        bookList.add(book);

        book = new Book("9780439136365", "Harry Potter and the Prisoner of Azkaban", "J.K. Rowling", 2001, "Fantasy, Thriller, Mystery", "This is some synopsis", R.drawable.placeholder);
        bookList.add(book);
